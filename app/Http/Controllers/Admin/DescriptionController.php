...
use App\Http\Requests\Master\DescriptionRequest;
...
class DescriptionController extends Controller
{
    ...
    public function index()
    {
        ...
        $bcrum = $this->bcrum('Uraian Fasilitas '.$nama,'MAIN MENU', '#', 'URAIAN FASILITAS '.$nama);
        return view('admin.master.descriptions.index', compact('bcrum','nama'));
    }
    ...
    public function store(DescriptionRequest $request)
    {
        ...
        try {
            ...
            $create = Description::create($data); 
            DB::commit();
