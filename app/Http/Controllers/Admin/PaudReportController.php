...
class PaudReportController extends Controller
{
    ...
    public function report(Request $request)
    {
        ...
        return view('admin.paud.report.report', compact('teachers', 'schools', 'bulan', 'employees', 'needs', 'students', 'facilities'));
    }
    ...
    public function teacher(Request $request)
    {
        ...
        $teachers = TeacherReport::OfSchoolId($request->school_id)
                    ...
                    ->OfTahun($request->tahun)
                    ->get();
        return view('admin.paud.report.teacher', compact('teachers', 'schools', 'bulan'));
    }
    ...
    public function employee(Request $request)
    {
        ...
        $employees = EmployeeReport::OfSchoolId($request->school_id)
                    ...
                    ->OfTahun($request->tahun)
                    ->get();
        return view('admin.paud.report.employee', compact('employees', 'schools', 'bulan'));
    }
    ...
    public function need(Request $request)
    {
        ...
        $needs     = NeedReport::OfSchoolId($request->school_id)
                    ...
                    ->OfTahun($request->tahun)
                    ->get();
        return view('admin.paud.report.need', compact('needs', 'schools', 'bulan'));
    }
    ...
    public function facility(Request $request)
    {
        ...
        $facilities = FacilityReport::OfSchoolId($request->school_id)
                    ...
                    ->OfTahun($request->tahun)
                    ->get();
                    return view('admin.paud.report.facility', compact('facilities', 'schools', 'bulan'));
    }
    ...
    public function student(Request $request)
    {
        ...
        $students  = StudentReport::OfSchoolId($request->school_id)
                    ...
                    ->orderBy('kelas', 'ASC')
                    ->get()->groupBy('no_urut');
        return view('admin.paud.report.student', compact('students', 'schools', 'bulan'));
    }
