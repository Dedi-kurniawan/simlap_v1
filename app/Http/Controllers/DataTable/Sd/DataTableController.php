...
namespace App\Http\Controllers\DataTable\Sd;
...
class DataTableController extends Controller
{
    ...
    public function pendikData()
    {
        ...
        ->addColumn('jlh_usia', function($data){
            return $data->usia_6+$data->usia_7+$data->usia_8+$data->usia_9+$data->usia_10+$data->usia_11+$data->usia_12+$data->usia_13+$data->usia_14+$data->usia_15;
        })
