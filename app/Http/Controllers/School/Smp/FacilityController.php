...
use App\Http\Requests\Smp\FacilityRequest;
...
class FacilityController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('school.smp.facilities.index', compact('bcrum', 'descriptions'));
    }
    ...
    public function generateReport()
    {
        ...
        try {
            ...
            if ($setting['status'] != "aktif") {
                ...
                $facility = Facility::with('user')->OfSchoolId($this->schoolId())->get();
                $record = [];
                $now = Carbon::now();
