...
use App\Http\Requests\Paud\NeedRequest;
...
class NeedController extends Controller
{
    ...
    {
        $bcrum     = $this->bcrum('Data Analisis Kebutuhan Guru', 'MAIN MENU', route('paud.kebutuhan-guru.index'), 'ANALISIS KEBUTUHAN GURU');
        $subjects  = Subject::select('id', 'nama')->where('role_id', '2')->get();
        $coloumn = $this->kurikulum(). " " .$this->roleNama();
        return view('school.paud.needs.index', compact('bcrum', 'subjects', 'coloumn'));
    }
