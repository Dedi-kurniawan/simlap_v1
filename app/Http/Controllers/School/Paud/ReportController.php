...
class ReportController extends Controller
{
    ...
    {
        $bcrum = $this->bcrum('Laporan', 'MAIN MENU', route('paud.laporan.index'), 'LAPORAN');
        $settings = Setting::distinct()->orderBy('tahun', 'asc')->get(['tahun']);
        return view('school.paud.reports.index', compact('bcrum', 'settings'));
    }
    ...
    public function show(Request $request)
    {
        ...
        return view('school.paud.reports.report', compact('teachers', 'schools', 'bulan', 'employees', 'needs', 'students', 'facilities'));
    }
