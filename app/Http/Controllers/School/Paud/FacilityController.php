...
use App\Http\Requests\Paud\FacilityRequest;
...
class FacilityController extends Controller
{
    ...
    {
        $bcrum     = $this->bcrum('Data Kondisi Sarana dan Prasarana Paud', 'MAIN MENU', route('smp.sarana-prasarana.index'), 'KONDISI SARANA DAN PRASARAN PAUD');
        $descriptions  = Description::select('id', 'nama')->get();
        return view('school.paud.facilities.index', compact('bcrum', 'descriptions'));
    }
