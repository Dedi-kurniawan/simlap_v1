...
class ReportController extends Controller
{
    ...
    {
        $bcrum = $this->bcrum('Laporan', 'MAIN MENU', route('sd.laporan.index'), 'LAPORAN');
        $settings = Setting::distinct()->orderBy('tahun', 'asc')->get(['tahun']);
        return view('school.sd.reports.index', compact('bcrum', 'settings'));
    }
    ...
    public function show(Request $request)
    {
        ...
        $schools = School::where('id', $this->schoolId())->with(['district', 'village', 'koordinator'])->first();
        return view('school.sd.reports.report', compact('teachers', 'schools', 'bulan', 'employees', 'needs', 'students', 'facilities'));
    }
