...
var table = $('#datatable').DataTable({
    ...
    ajax: {
        method: 'POST',
    	url: HOST_URL + '/dt/admin/sd/sarana-prasarana',
        data: function (d) {
...
$(document).on("click", "#showData", function (e) {
    ...
    if (data) {
        var id = data.id;
        var url   = HOST_URL + '/admin/sd/sekolah/' + id;
        $.get(url, function (d) {
            if (d.status == 'success') {
...
function printReport(){
    ...
    var url = HOST_URL + '/admin/sd/sarana-prasarana/print?school_id='+ school_id +'&bulan='+bulan+'&tahun='+tahun;
