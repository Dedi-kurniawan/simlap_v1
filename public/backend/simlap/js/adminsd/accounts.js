...
$(document).on("click", "#editData", function (e) {
    ...
    if (data) {
        var id = data.id;
        var url   = HOST_URL + '/admin/sd/akun/' + id + '/edit';
        $.get(url, function (d) {
            if (d.status == 'success') {
...
$("#submitData").click(function (event) {
    ...
    if (action == "add") {
        var url = HOST_URL + '/admin/sd/akun';
        var title = "TAMBAH DATA";
    } else if (action == "edit") {
        var id    = $("#id_edit").val();
        var url   = HOST_URL + '/admin/sd/akun/' + id;
        var title = "UBAH DATA";
    }
...
function updateStatus(id, status) {
    ...
    var action = "edit";
    $.ajax({
        url: HOST_URL + '/admin/sd/status/'+id,
        method: 'POST',
        dataType: 'json',
        data: {
            status  : status,
...
function resetPassword(id) {
    ...
    var action = "delete";
    $.ajax({
        url: HOST_URL + '/admin/sd/akun/reset/' + id,
        method: "POST",
        dataType: 'json',
        success: function (d) {
            finishLoading();
