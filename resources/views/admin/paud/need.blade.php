                    ...
                    <table class="table nowrap table-sm table-head-custom table-head-bg table-vertical-center" id="datatable" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th data-toggle="tooltip" title="RATA-RATA JAM PERMINGGU" data-placement="left">RATA-RATA JAM PERMINGGU</th>
                                <th data-toggle="tooltip" title="STATUS KEPEGAWAIAN" data-placement="left">STS KEPEGAWAIAN</th>
                                <th data-toggle="tooltip" title="KETERANGAN" data-placement="left">KETERANGAN</th>
                                <th id="kurikulum"></th>
                            </tr>
                        </thead>
...
@endsection
@push('scripts')
    <script src="{{ asset('backend/simlap/js/adminpaud/needs.js') }}?v{{ date('ymdhis') }}"></script>
@endpush