<div class="modal fade" id="formResetReport" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary font-weight-bold" id="resetReport">
                    <i class="fa fa-file"></i> Reset Laporan
                </button>
            </div>
        </div>
    </div>
