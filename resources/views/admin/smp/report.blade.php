    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">Rekapitulasi {{ $bcrum['title'] }}
                        <span class="d-block text-muted pt-2 font-size-sm">Cetak Rekapitulasi {{ $bcrum['title'] }}</span></h3>
                    </div>
                    
                </div>
                <div class="card-body">
                    <form id="form_validate_rekap">
                        <div class="form-group row">
                            <div class="col-lg-3 col-sm-12">
                                <label>KECAMATAN:</label>
                                <select class="form-control selectform" id="district_id" name="kecamatan" title="kolom kecamatan dilarang kosong">
                            ...
                            <div class="col-lg-2 col-sm-12">
                                <label>BULAN: <span class="text-danger">*</span></label>
                                <select class="form-control selectform" id="bulan_rekap" name="bulan_rekap" title="kolom bulan di larang kosong" required>
                                    <option value="">PILIH BULAN</option>
                                    <option value="01">JANUARI</option>
                                    <option value="02">FEBRUARI</option>
                                    <option value="03">MARET</option>
                            ...
                            <div class="col-lg-2 col-sm-12">
                                <label>TAHUN: <span class="text-danger">*</span></label>
                                <select class="form-control selectform" id="tahun_rekap" name="tahun_rekap" title="kolom tahun di larang kosong" required>
                                    <option value="">PILIH TAHUN</option>
                                    @foreach ($settings as $s)
                                        <option value="{{ $s->tahun }}">{{ $s->tahun }}</option>
                                    @endforeach
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-12">
                                ...
                                <select class="form-control selectform" id="laporan_rekap" name="laporan_rekap" title="kolom laporan di larang kosong" required>
                            ...
                            <div class="col-lg-3 col-sm-12">
                                <label>AKSI: <span class="text-danger">*</span></label>
                                <div></div>
                                <button type="button" onclick="printRekap()" class="btn btn-primary"><i class="fa fa-print"></i> CETAK REKAP</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<!--end::Content-->
@include('admin.smp.modal._reset')
@endsection
@push('scripts')
    <script src="{{ asset('backend/simlap/js/adminsmp/reports.js') }}?v{{ date('ymdhis') }}"></script>
@endpush