    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <span class="text-muted font-weight-bold mr-4">SD BENGKULU UTARA</span>
                <!--end::Actions-->
            </div>
            <!--end::Info-->
            <!--begin::Toolbar-->
                    ...
                    <table class="table nowrap table-sm table-head-custom table-head-bg table-vertical-center" id="datatable" style="width:100%">
                        <thead>
                            <tr>
                                <th>NO</th>
                                <th>MAPEL</th>
                                <th>ROMBEL SISWA/BK</th>
                                <th data-toggle="tooltip" title="JUMLAH JAM PEROMBEL" data-placement="left">JLH JAM PEROMBEL</th>
                                <th>TOTAL JAM</th>
                                <th data-toggle="tooltip" title="JUMLAH GURU" data-placement="left">JLH GURU</th>
                                <th data-toggle="tooltip" title="RATA-RATA JAM PERMINGGU" data-placement="left">RATA2 JAM PERMINGGU</th>
                                <th data-toggle="tooltip" title="STATUS KEPEGAWAIAN" data-placement="left">STS KEPEGAWAIAN</th>
                                <th data-toggle="tooltip" title="KETERANGAN" data-placement="left">KET</th>
                                <th id="kurikulum"></th>
                            </tr>
                        </thead>
...
@endsection
@push('scripts')
    <script src="{{ asset('backend/simlap/js/adminsd/needs.js') }}?v{{ date('ymdhis') }}"></script>
@endpush