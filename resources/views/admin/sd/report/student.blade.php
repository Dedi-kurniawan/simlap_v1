        ...
        <table class="tg" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th colspan="11" class="tg-need">JMLH SISWA BERDASARKAN UMUR</th>
            ...
            <tbody>
                ...
                @forelse ($students as $student)
                    ...
                    <tr style="background-color: #c0c0c0; font-weight: bold;">
                        ...
                        <td class="text-center">{{ $student->sum('usia_6')+$student->sum('usia_7')+$student->sum('usia_8')+$student->sum('usia_9')+$student->sum('usia_10')+$student->sum('usia_11')+$student->sum('usia_12')+$student->sum('usia_13')+$student->sum('usia_14')+$student->sum('usia_15') }} </td>
                        ...
                        <td class="text-center">{{ $student->sum('islam')+$student->sum('katolik')+$student->sum('protestan')+$student->sum('hindu')+$student->sum('budha')+$student->sum('lain') }}</td>
                    </tr>
                @empty
                    <tr>
