                    ...
                    <div class="mb-3">
                        <div class="mb-2">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    <label>TINGKAT/URUTAN:<span class="text-danger">*</span></label>
                                    <input type="number" class="form-control" autocomplete="off" name="no_urut" id="no_urut" title="kolom tingkat di larang kosong" placeholder="TINGKAT/URUTAN..." required/>
                                </div>
                                <div class="col-lg-6">
                                    <label>KELAS:<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" autocomplete="off" name="kelas" id="kelas" placeholder="KELAS..." required/>
                                </div>
                            </div>
                        </div>
                    </div>
