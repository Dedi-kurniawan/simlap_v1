                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <div class="col-12 col-lg-3 col-md-3">
                                    ...
                                    <select class="form-control selectFilter" id="filter_semester">
                                ...
                                <div class="col-12 col-lg-3 col-md-3">              
                                    ...
                                    <select class="form-control selectFilter" id="filter_tahun">
...
<!--end::Content-->
@include('admin.master.settings._form')
@endsection
@push('scripts')
    <script src="{{ asset('backend/simlap/js/master/settings.js') }}?v{{ date('ymdhis') }}"></script>
@endpush