            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        ...
                        <span class="d-block text-muted pt-2 font-size-sm">Menampilkan data Uraian yang di gunakan di PAUD,SD,SMP</span></h3>
                    </div>
...
<!--end::Content-->
@include('admin.master.descriptions._form')
@endsection
@push('scripts')
    <script src="{{ asset('backend/simlap/js/master/descriptions.js') }}?v{{ date('ymdhis') }}"></script>
@endpush