                        ...
                        <div class="mb-2">
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" maxlength="100" autocomplete="off" name="nama" id="nama" title="kolom kecamatan di larang kosong" placeholder="KECAMATAN..." required/>
                                </div>
                            </div>
                        </div>
                    </div>
