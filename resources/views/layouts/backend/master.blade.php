...
<html lang="en">
	...
	<head>
		{{-- <base href="../../"> --}}
		<meta charset="utf-8" />
		<title>SIMLAP | DINAS PENDIDIKAN BENGKULU UTARA</title>
		...
		<link href="{{ asset('backend/assets/css/themes/layout/brand/light.css') }}" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			<!--begin::Logo-->
			<a href="#">
				<img alt="Logo" src="{{ asset('backend/assets/logo/logo-w.png') }}" style="width: 150px"/>
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
		...
		<!--end::Scrolltop-->
		@if (isset($key))
			@if ($key == "not_complated")
				@include('layouts.backend.partials._key')
			@endif
		@endif
		...
		<script src="{{ asset('backend/simlap/js/jquery.key.js') }}"></script>
		<script src="{{ asset('backend/assets/plugins/custom/jquery-validation/jquery.validate.min.js') }}"></script>
		<script src="{{ asset('backend/simlap/js/custome.js') }}?v{{ date('ymdhis') }}"></script>
		<!--end::Page Vendors-->
