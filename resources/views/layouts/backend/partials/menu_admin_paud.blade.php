<ul class="menu-nav">
    ...
    <li class="menu-item {{ (request()->is('admin/paud/dashboard')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
        <a href="{{ route('admin.paud.dashboard') }}" class="menu-link">
            <span class="svg-icon menu-icon">
                <i class="far fa-chart-bar {{ (request()->is('admin/paud/dashboard')) ? 'text-primary' : '' }}"></i>
            </span>
    ...
    <li class="menu-item {{ (request()->is('admin/paud/tenaga-pendidik')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
        <a href="{{ route('admin.paud.tenaga-pendidik') }}" class="menu-link">
            <span class="svg-icon menu-icon">
                <i class="fa fa-chalkboard-teacher {{ (request()->is('admin/paud/tenaga-pendidik')) ? 'text-primary' : '' }}"></i>
            </span>
    ...
    <li class="menu-item {{ (request()->is('admin/paud/tenaga-kependidikan')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
        <a href="{{ route('admin.paud.tenaga-kependidikan') }}" class="menu-link">
            <span class="svg-icon menu-icon">
                <i class="fa fa-user-friends {{ (request()->is('admin/paud/tenaga-kependidikan')) ? 'text-primary' : '' }}"></i>
            </span>
    ...
    <li class="menu-item {{ (request()->is('admin/paud/kebutuhan-guru')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
        <a href="{{ route('admin.paud.kebutuhan-guru') }}" class="menu-link">
            <span class="svg-icon menu-icon">
                <i class="fas fa-users-cog {{ (request()->is('admin/paud/kebutuhan-guru')) ? 'text-primary' : '' }}"></i>
            </span>
    ...
    <li class="menu-item {{ (request()->is('admin/paud/peserta-didik')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
        <a href="{{ route('admin.paud.peserta-didik') }}" class="menu-link">
            <span class="svg-icon menu-icon">
                <i class="fas fa-users {{ (request()->is('admin/paud/peserta-didik')) ? 'text-primary' : '' }}"></i>
            </span>
    ...
    <li class="menu-item {{ (request()->is('admin/paud/sarana-prasarana')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
        <a href="{{ route('admin.paud.sarana-prasarana') }}" class="menu-link">
            <span class="svg-icon menu-icon">
                <i class="fas fa-building {{ (request()->is('admin/paud/sarana-prasarana')) ? 'text-primary' : '' }}"></i>
            </span>
    ...
    <li class="menu-item {{ (request()->is('admin/paud/laporan')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
        <a href="{{ route('admin.paud.laporan') }}" class="menu-link">
            <span class="svg-icon menu-icon">
                <i class="fas fa-file-alt {{ (request()->is('admin/paud/laporan')) ? 'text-primary' : '' }}"></i>
            </span>
