<ul class="menu-nav">
    ...
    <li class="menu-item {{ (request()->is('admin/smp/dashboard')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
        <a href="{{ route('admin.smp.dashboard') }}" class="menu-link">
            <span class="svg-icon menu-icon">
                <i class="far fa-chart-bar {{ (request()->is('admin/smp/dashboard')) ? 'text-primary' : '' }}"></i>
            </span>
    ...
    <li class="menu-item {{ (request()->is('admin/smp/tenaga-pendidik')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
        <a href="{{ route('admin.smp.tenaga-pendidik') }}" class="menu-link">
            <span class="svg-icon menu-icon">
                <i class="fa fa-chalkboard-teacher {{ (request()->is('admin/smp/tenaga-pendidik')) ? 'text-primary' : '' }}"></i>
            </span>
    ...
    <li class="menu-item {{ (request()->is('admin/smp/tenaga-kependidikan')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
        <a href="{{ route('admin.smp.tenaga-kependidikan') }}" class="menu-link">
            <span class="svg-icon menu-icon">
                <i class="fa fa-user-friends {{ (request()->is('admin/smp/tenaga-kependidikan')) ? 'text-primary' : '' }}"></i>
            </span>
    ...
    <li class="menu-item {{ (request()->is('admin/smp/kebutuhan-guru')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
        <a href="{{ route('admin.smp.kebutuhan-guru') }}" class="menu-link">
            <span class="svg-icon menu-icon">
                <i class="fas fa-users-cog {{ (request()->is('admin/smp/kebutuhan-guru')) ? 'text-primary' : '' }}"></i>
            </span>
    ...
    <li class="menu-item {{ (request()->is('admin/smp/peserta-didik')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
        <a href="{{ route('admin.smp.peserta-didik') }}" class="menu-link">
            <span class="svg-icon menu-icon">
                <i class="fas fa-users {{ (request()->is('admin/smp/peserta-didik')) ? 'text-primary' : '' }}"></i>
            </span>
    ...
    <li class="menu-item {{ (request()->is('admin/smp/sarana-prasarana')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
        <a href="{{ route('admin.smp.sarana-prasarana') }}" class="menu-link">
            <span class="svg-icon menu-icon">
                <i class="fas fa-building {{ (request()->is('admin/smp/sarana-prasarana')) ? 'text-primary' : '' }}"></i>
            </span>
    ...
    <li class="menu-item {{ (request()->is('admin/smp/laporan')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
        <a href="{{ route('admin.smp.laporan') }}" class="menu-link">
            <span class="svg-icon menu-icon">
                <i class="fas fa-file-alt {{ (request()->is('admin/smp/laporan')) ? 'text-primary' : '' }}"></i>
            </span>
