...
<body class="A4 landscape">
    <section class="sheet padding-10mm">
        ...
        <table class="tg" style="width: 100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="tg-qr5b text-center">{!! $t->jenis_kelamin == "L" ? "<span>&#10003;</span>" : "-" !!}
                    </td>
                    <td class="tg-qr5b text-center">{!! $t->jenis_kelamin == "P" ? "<span>&#10003;</span>" : "-" !!}
                    </td>
                    <td class="tg-qr5b text-center">{!! $t->status_pegawai == "PNS" ? "<span>&#10003;</span>" : "-" !!}
                    </td>
                    <td class="tg-qr5b text-center">{!! $t->status_pegawai == "GBD" ? "<span>&#10003;</span>" : "-" !!}
                    </td>
                    <td class="tg-qr5b text-center">{!! $t->status_pegawai == "GTT" ? "<span>&#10003;</span>" : "-" !!}
                    </td>
                    <td class="tg-qr5b text-center">{!! $t->status_pegawai == "GTY" ? "<span>&#10003;</span>" : "-" !!}
                    </td>
        ...
        <table class="tg" class="tg" style="width: 100%">
            <thead>
                <tr>
                    <th class="tg-tu9x" rowspan="2">NO</th>
                    <th class="tg-tu9x" rowspan="2">NAMA</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="tg-qr5b text-center">{!! $e->jenis_kelamin == "L" ? '<span>&#10003;</span>' : "-" !!}
                    </td>
                    <td class="tg-qr5b text-center">{!! $e->jenis_kelamin == "P" ? "<span>&#10003;</span>" : "-" !!}
                    </td>
                    <td class="tg-qr5b text-center">{!! $e->status_pegawai == "PNS" ? "<span>&#10003;</span>" : "-" !!}
                    </td>
                    <td class="tg-qr5b text-center">{!! $e->status_pegawai == "PTT" ? "<span>&#10003;</span>" : "-" !!}
                    </td>
                    <td class="tg-qr5b text-center">{!! $e->status_pegawai == "PTY" ? "<span>&#10003;</span>" : "-" !!}
                    </td>
