                    ...
                    <div class="mb-3">
                        <div class="mb-2">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    <label>NUPTK:</label>
                                    <input type="number" class="form-control" name="nuptk" id="nuptk" placeholder="NUPTK..."  />
                                </div>
                                <div class="col-lg-4">
                                    <label>NIP/NIPGB:</label>
                                    <input type="text" class="form-control" autocomplete="on" name="nip" id="nip" placeholder="NIP..." />
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-lg-4">
                                    <label>TMT SEBAGAI GURU CAPEG/GBD/GTT/GTY:</label>
                                    <input type="text" class="form-control date_picker" name="tmt_sebagai_guru" id="tmt_sebagai_guru" placeholder="TMT SEBAGAI GURU CAPEG/GBD/GTT/GTY..."  />
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-4">
                                    <label>TMT DI SEKOLAH INI: <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control date_picker" autocomplete="off" maxlength="50" required name="tmt_sekolah" id="tmt_di_sekolah_ini" placeholder="TMT DI SEKOLAH INI..." />
                                </div>
                                <div class="col-lg-4">
                                    <label>MAPEL/JABATAN: <span class="text-danger">*</span></label>
                                    <select class="form-control selectform" id="mapel" name="mapel[]" multiple required>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-4">
                                    ...
                                    <input type="text" class="form-control date_picker" required name="tmt_jabatan" id="tmt_jabatan" placeholder="TMT JABATAN..."  />
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <select class="form-control selectform" id="jurusan" name="jurusan" required title="kolom jurusan di larang kosong">
                                ...
                                <div class="col-lg-4">
                                    <label>JJM:</label>
                                    <input type="number" class="form-control" name="jjm" id="jjm" placeholder="JJM..."  />
                                </div>
                            </div>
                        </div>
                    </div>
