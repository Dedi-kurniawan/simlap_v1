    ...
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-uppercase" id="exampleModalLabel">Laporan peserta didik {{ $bcrum['report']['bulan'] }} {{ $bcrum['report']['tahun'] }}</h5>
            ...
            <div class="modal-body text-center">
                <div class="content-generate" style="display: none">
                    ...
                    <h6>Pastikan semua data peserta didik sudah benar sebelum generate laporan</h6>
                </div>
