                    ...
                    <div class="mb-3">
                        <div class="mb-2">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-3">
                                    <label>UMUR 7<span class="text-danger">*</span></label>
                                    <input type="number" class="form-control" autocomplete="off" value="0"  name="usia_7" id="usia_7" placeholder="UMUR 7..."  required/>
                                </div>
                                <div class="col-3">
                                    <label>UMUR 8<span class="text-danger">*</span></label>
                                    <input type="number" class="form-control" autocomplete="off" value="0"  name="usia_8" id="usia_8" placeholder="UMUR 8..."  required/>
                                </div>     
                                <div class="col-3">
                                    <label>UMUR 9<span class="text-danger">*</span></label>
                                    <input type="number" class="form-control" autocomplete="off" value="0"  name="usia_9" id="usia_9" placeholder="UMUR 9..."  required/>
                                </div>                                                       
                            </div>
                            <div class="form-group row">
                                <div class="col-lg-4">
                                    <label>UMUR 10<span class="text-danger">*</span></label>
                                    <input type="number" class="form-control" autocomplete="off" value="0"  name="usia_10" id="usia_10" placeholder="UMUR 10..."  required/>
                                </div>
                                <div class="col-lg-4">
