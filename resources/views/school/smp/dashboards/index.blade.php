                            ...
                            <div class="pt-5">
                                @if ($setting['status'] == "aktif")
                                    @if ($report['status'] == 'ada')
                                        @if ($report['teacher'] == 0)
                                            <a href="{{ route('smp.tenaga-pendidik.index') }}" class="btn btn-success btn-shadow-hover font-weight-bolder w-100 py-3">TENAGA PENDIDIK</a>
                                        @elseif($report['employee'] == 0)
                                            <a href="{{ route('smp.tenaga-kependidikan.index') }}" class="btn btn-success btn-shadow-hover font-weight-bolder w-100 py-3">TENAGA KEPENDIDIKAN</a>
                                        @elseif($report['need'] == 0)
                                            <a href="{{ route('smp.kebutuhan-guru.index') }}" class="btn btn-success btn-shadow-hover font-weight-bolder w-100 py-3">ANALISIS KEBUTUHAN GURU</a>
                                        @elseif($report['student'] == 0)
                                            <a href="{{ route('smp.peserta-didik.index') }}" class="btn btn-success btn-shadow-hover font-weight-bolder w-100 py-3">PESERTA DIDIK</a>
                                        @elseif($report['facility'] == 0)
                                            <a href="{{ route('smp.sarana-prasarana.index') }}" class="btn btn-success btn-shadow-hover font-weight-bolder w-100 py-3">SARANA & PRASARANA</a>
                                        @else
