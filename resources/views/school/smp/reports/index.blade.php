                        ...
                        <div class="form-group row">
                            ...
                            {{-- <div class="col-lg-4">
                                ...
                                <select class="form-control selectform" id="laporan" name="laporan" title="kolom laporan di larang kosong" required>
                                    ...
                                    <option value="tenkendik">TENAGA KEPENDIDIKAN</option>
                                    <option value="analisis">ANALISI KEBUTUHAN GURU</option>
                                    <option value="pendik">PESERTA DIDIK</option>
                                    <option value="sarana">KONDISI SARANA DAN pRASARANA</option>
                                </select>
                            </div> --}}
                            <div class="col-lg-4">
...
function printReport(){
    ...
    var url = HOST_URL + '/smp/laporan/show?bulan='+bulan+'&tahun='+tahun;
