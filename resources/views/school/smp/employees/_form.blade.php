                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <div class="mb-2">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-4">
                                    <label>TMT SEBAGAI PEGAWAI/CAPEG:</label>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-4">
                                    ...
                                    <div class="radio-inline">
                                        <label class="radio">
                                            <input type="radio" class="laki" name="jenis_kelamin" id="jenis_kelamin" required value="L"/>
                                            <span></span>
                                            LAKI-LAKI
                                        </label>
                                        <label class="radio">
                                            <input type="radio" class="perempuan" name="jenis_kelamin" value="P"/>
                                            <span></span>
                                            PEREMPUAN
                                        </label>
                                    </div>
