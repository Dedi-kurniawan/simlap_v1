                ...
                <div class="col-xl-4 col-12">
                    ...
                    <div class="card card-custom bg-info card-stretch gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <span class="font-weight-bold text-white font-size-sm">Jumlah Pendidik</span>
                        </div>
                        <!--end::Body-->
                    </div>
                    <!--end::Stats Widget 30-->
            ...
            <div class="card card-custom gutter-b">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table nowrap table-sm table-head-custom table-head-bg table-vertical-center wrap" id="datatable" style="width:100%">
                            <thead>
                                <tr>
                                    <th>NO</th>
                                    <th>NAMA</th>
                                    ...
                                    <th>PENDIDIKAN</th>
                                    <th>JABATAN</th>
                                    <th data-toggle="tooltip" title="PANGKAT/GOLONGAN" data-placement="left">GOL</th>
                                    <th data-toggle="tooltip" title="TERHITUNG MULAI TANGGAL GOLONGAN" data-placement="left">TMT GOL</th>
                                    <th data-toggle="tooltip" title="TUGAS MENGAJAR" data-placement="left">TUGAS MENGAJAR</th>
                                    <th data-toggle="tooltip" title="TANGGAL MULAI BEKERJA" data-placement="left">TGL Mulai bekerja</th>                                    
                                    <th data-toggle="tooltip" title="TERHITUNG MULAI TANGGAL CALON PEGAWAI" data-placement="left">TMT CAPEG</th>
                                    <th>KECAMATAN</th>
                                    <th>DESA</th>
                                    <th>ALAMAT RUMAH</th>
                                    <th>PELATIHAN</th>
                                    <th>SERTIFIKASI</th>
                                    <th>SERTIFIKASI THN</th>
                                </tr>
                            </thead>
...
<!--end::Content-->
@include('school.paud.teachers._form')
@include('school.paud.teachers._report')
@endsection
@push('scripts')
    <script src="{{ asset('backend/simlap/js/paud/teachers.js') }}?v{{ date('ymdhis') }}"></script>
@endpush